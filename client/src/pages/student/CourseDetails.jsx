    ...
    <>
      <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-center md:px-36 px-8 md:pt-30 pt-20 text-left'>
        ...
        <div className=''>
          ...
          <p className='text-sm'>Course by <span className='text-blue-600 underline'>{courseData.educator?.name || 'Unknown Instructor'}</span></p>
                ...
                <div key={index} className='border border-gray-300 bg-white mb-2 rounded'>
                  <div className='flex items-center justify-between px-4 py-3 cursor-pointer select-none' onClick={(() => toggleSection(index))}>
                    <div className='flex items-center gap-2 '>
                      <img className={`transition-transform duration-300 ${openSections[index] ? 'rotate-180' : 'rotate-0'}`}
